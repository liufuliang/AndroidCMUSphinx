...
LOCAL_SRC_FILES := \
	fe_interface.c \
	fe_sigproc.c \
	fe_sigproc_arm_data.s \
	fe_sigproc_arm_code.s \
	fe_warp_affine.c \
	fe_warp.c \
...
LOCAL_MODULE := sphinxbaseDebug

LOCAL_SRC_FILES := emu_sys_log.c	\
				   cyVoiceE_model.c
...
#################################### test_sphinx ###############################################
include $(CLEAR_VARS)
LOCAL_C_INCLUDES := $(SPHINX_PATH)/test_sphinx/tinyxml/tinyxml_inc \
					$(SPHINX_PATH)/test_sphinx \
...
LOCAL_PATH := $(SPHINX_PATH)/test_sphinx
			  
LOCAL_MODULE := test_sphinx

LOCAL_SRC_FILES := test_sphinx.cpp \
				   tinyxml/tinyxml_src/tinystr.cpp \
				   tinyxml/tinyxml_src/tinyxml.cpp \
				   tinyxml/tinyxml_src/tinyxmlerror.cpp \
				   tinyxml/tinyxml_src/tinyxmlparser.cpp
...
LOCAL_STATIC_LIBRARIES := \
  ...
  sphinxfe \
  sphinxutil 
LOCAL_WHOLE_STATIC_LIBRARIES := sphinxbaseDebug test_sphinx
