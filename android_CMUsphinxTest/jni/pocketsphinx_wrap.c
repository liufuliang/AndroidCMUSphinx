...
SWIGEXPORT jlong JNICALL Java_edu_cmu_pocketsphinx_pocketsphinxJNI_new_1Decoder_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  Iava_SysPrintf("Java_edu_cmu_pocketsphinx_pocketsphinxJNI_new_1Decoder_1_1SWIG_11 +++++++++++++++++++++++++++++++++");
...
SWIGEXPORT jint JNICALL Java_edu_cmu_pocketsphinx_pocketsphinxJNI_Decoder_1processRaw_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jshortArray jarg2, jlong jarg3, jboolean jarg4, jboolean jarg5) {
  ...
  unsigned int begin,end,begin0,end0;
#endif
  ...
  Iava_SysPrintf("Decoder_processRaw__SWIG_1 000 use %d us!!!",end-begin);
#endif
...
#if (CMU_SPHINX_TEST_PERFORMANCE == 1)
  begin = Iava_SysGetUS();
  Iava_SysPrintf("Decoder_processRaw__SWIG_1 001 use %d us!!!",begin-end);
#endif
...
#if (CMU_SPHINX_TEST_PERFORMANCE == 1)
  end0 = end = Iava_SysGetUS();
  Iava_SysPrintf("Decoder_processRaw__SWIG_1 002 use %d us!!!",end-begin);
  Iava_SysPrintf("Decoder_processRaw__SWIG_1 003 tatol use %d us!!!",end0-begin0);
#endif
...
#include "test_sphinx.h"
SWIGEXPORT void JNICALL Java_edu_cmu_pocketsphinx_pocketsphinxJNI_testSphinxModel(JNIEnv *jenv, jclass jcls, jstring jarg1, jstring jarg2, jstring jarg3, jstring jarg4, jstring jarg5) {
  char *xml = NULL;
  char *log = NULL;
  char *hmm = NULL;
  char *lm = NULL;
  ...
  if ((jarg1) && (jarg2) && (jarg3) && (jarg4) && (jarg5) ) {
    xml = (char *)(*jenv)->GetStringUTFChars(jenv, jarg1, 0);
    if (!xml) return;
    	
    log = (char *)(*jenv)->GetStringUTFChars(jenv, jarg2, 0);
    if (!log) return;
    	
    hmm = (char *)(*jenv)->GetStringUTFChars(jenv, jarg3, 0);
    if (!hmm) return;
    	
    lm = (char *)(*jenv)->GetStringUTFChars(jenv, jarg4, 0);
    if (!lm) return;
    	
    dic = (char *)(*jenv)->GetStringUTFChars(jenv, jarg5, 0);
    if (!dic) return;
  }
  ret = test_sphinx_model(xml,log,hmm,lm,dic);
  
  if (xml) (*jenv)->ReleaseStringUTFChars(jenv, jarg1, (const char *)xml);
  if (log) (*jenv)->ReleaseStringUTFChars(jenv, jarg2, (const char *)log);
  if (hmm) (*jenv)->ReleaseStringUTFChars(jenv, jarg3, (const char *)hmm);
  if (lm) (*jenv)->ReleaseStringUTFChars(jenv, jarg4, (const char *)lm);
  if (dic) (*jenv)->ReleaseStringUTFChars(jenv, jarg5, (const char *)dic);
}
