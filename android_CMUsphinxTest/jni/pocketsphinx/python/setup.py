...
# If there is no /cygdrive/d/lfl/Sphinx/pocketsphinx/../sphinxbase and friends use pkg-config
if '/cygdrive/d/lfl/Sphinx/pocketsphinx/../sphinxbase' == '' or '/cygdrive/d/lfl/Sphinx/pocketsphinx/../sphinxbase' == '':
    sbconf = pkgconfig('sphinxbase')
    sb_libdirs = sbconf.get('library_dirs', [])
    sb_includes = sbconf.get('include_dirs', [])
else:
    sb_includes = ['/cygdrive/d/lfl/Sphinx/pocketsphinx/../sphinxbase/include',
                   '/cygdrive/d/lfl/Sphinx/pocketsphinx/../sphinxbase/include']
    sb_libdirs = ['/cygdrive/d/lfl/Sphinx/pocketsphinx/../sphinxbase/src/libsphinxbase/.libs']
